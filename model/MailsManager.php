...
class MailsManager
{
    ...
    public function getMessages($userId,$mp_read)
    {
        ...
        $executeIsOk= $this->pdostatement->execute();
        $unseenMessages = [];
        while ($unseenMessage= $this->pdostatement->fetchObject("model\Projet5_mails")){
    ...
    public function getSentMessages($userId)
    {
        ...
        $executeIsOk= $this->pdostatement->execute();
        $sentMessages = [];
        while ($sentMessage= $this->pdostatement->fetchObject("model\Projet5_mails")){
    ...
    public function readMessages($messageId,$userId,$from,$to)
    {
        ...
        $executeIsOk= $this->pdostatement->execute();
        if($executeIsOk){
            $unseenMessage = $this->pdostatement->fetchObject('model\Projet5_mails');
